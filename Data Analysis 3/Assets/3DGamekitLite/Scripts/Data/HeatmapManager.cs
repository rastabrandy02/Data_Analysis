...
public class HeatmapManager : MonoBehaviour
{
    ...
    enum HeatmapType { None, Position, Jump, Damaged, Damager, Death, Path }
    ...
    List<Vector3> damagerPositionsList = new List<Vector3>();
    ...
    {
        WWW www = new WWW("https://citmalumnes.upc.es/~ogylandyy/importjump.php");
    ...
    {
        WWW www = new WWW("https://citmalumnes.upc.es/~ogylandyy/importposition.php");
    ...
    {
        WWW www = new WWW("https://citmalumnes.upc.es/~ogylandyy/importdamaged.php");
    ...
    IEnumerator GetDamagerData()
    {
        ...
        {
            string[] parts = damagedData[i].Split(" ");
            int x = int.Parse(parts[6]);
            int y = int.Parse(parts[7]);
            int z = int.Parse(parts[8]);
    ...
    {
        WWW www = new WWW("https://citmalumnes.upc.es/~ogylandyy/importdeath.php");
  ...
  /*  IEnumerator GetEnemiesKilledData()
    {
        WWW www = new WWW("https://citmalumnes.upc.es/~ogylandyy/importenemy.php");
    ...
    {
        WWW www = new WWW("https://citmalumnes.upc.es/~ogylandyy/importpath.php");
