...
namespace Gamekit3D
{
    ...
    public class Data_Listener : MonoBehaviour, IMessageReceiver
    {
        ...
        IEnumerator UploadJump(Vector3 position)
        {
            ...
            UnityWebRequest www = UnityWebRequest.Post("https://citmalumnes.upc.es/~fernandofg2/jump.php", form);
            yield return www.SendWebRequest();
        ...
        IEnumerator UploadPosition(Vector3 position)
        {
            ...
            UnityWebRequest www = UnityWebRequest.Post("https://citmalumnes.upc.es/~fernandofg2/position.php", form);
            yield return www.SendWebRequest();
